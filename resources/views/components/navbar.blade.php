    ...
    <div class="max-w-screen-xl mx-auto px-6 md:px-10">
        <div class="flex justify-between items-center py-6">
            ...
            <button @click="open = !open"
                class="md:hidden flex items-center justify-center w-10 h-10 rounded-lg focus:outline-none group"
            ...
            <div class="hidden md:flex items-center justify-end w-full space-x-10" id="navbar-default">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <!-- Auth Menu -->
                    @guest
                        <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-700 font-medium">
                            Login
                        </a>
                    @else
                        <div class="relative">
                            <button id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar"
                                ...
                                <div class="w-9 h-9 bg-blue-700 text-white rounded-full flex items-center justify-center font-bold text-sm uppercase">
                                    {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                                </div>
                                <span class="hidden md:inline text-sm font-medium text-gray-700 hover:text-blue-700">{{ Auth::user()->name }}</span>
                            </button>
       ...
       <!-- Mobile Menu -->
        <div x-show="open" x-transition.duration.300ms class="md:hidden">
