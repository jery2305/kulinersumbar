<footer class="bg-gradient-to-br from-gray-900 to-gray-800 text-gray-300 pt-12 pb-8 px-6 mt-24">
    ...
    <p class="text-sm text-gray-400 leading-relaxed">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                ...
                <li><a href="/pengiriman" class="hover:text-white transition">Pengiriman</a></li>
            </ul>
        </div>
            ...
            <div class="flex space-x-4">
                ...
                <a href="https://facebook.com" target="_blank" class="hover:text-white transition">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M22 12a10 10 0 10-11.5 9.9v-7H8v-2.9h2.5v-2.2c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.3 0-1.7.8-1.7 1.6v1.9h3l-.5 2.9h-2.5v7A10 10 0 0022 12z"/>
                    </svg>
                </a>
                <!-- Instagram -->
